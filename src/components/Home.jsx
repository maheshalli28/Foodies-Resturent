    ...
    <>
      ...
      <section id='home' className="hero">
        <div className="overlay">
          ...
          <button className=" btn btn-lg btn-outline-secondary  border-2 rounded-5 mt-3 text-light"><a className='text-white text-decoration-none' href='#about'>About </a> <FaCircleArrowRight className='me-1' size={25} /></button>
          </div>
         </h2>
        </div>
      </section>
